...
export default function CustomError({statusCode,  errorMessage, errorReference}) {

  return (
    <>
        <CommonLayout
            parent="home"
            title="ResumeGuru -  Internal Server Error"
            meta_title="ResumeGuru -  Internal Server Error"
            ...
            <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="mt-6 text-base leading-7 text-gray-600">
                        Sorry, an internal server error occurred. Error Reference ID : {errorReference}.
                        When you contact support, please provide this error reference ID.
                    </p>
