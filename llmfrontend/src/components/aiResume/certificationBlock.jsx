...
const CertificationBlock = ({addNewEnable}) => {
    ...
    const handleEditCertificationAction = ()=>{
        if (certificationNameEditInput === "" || certificationIssueOrgEditInput === "" ){
            ...
            // setCertificationNameEditInput("");
            // setCertificationIssueOrgEditInput("");
            // setCertificationIdEditInput("");
            // setCertificationUrlEditInput("");
            // setCertificationIssueDateEditInput("");
            // setCertificationExpirationDateEditInput("");
        }
        ...
        <div className="max-w-7xl px-2 py-2 sm:px-2 lg:px-2 lg:py-2 mx-auto">
              <h2 className="text-xl flex">
                  <div className="text-xl font-large leading-6 text-black-900 ">
                     ...
                     Certifications ({resumeDetails && resumeDetails.certifications && resumeDetails.certifications.length > 0 ? resumeDetails.certifications.length : 0})
                      </div>
                  </div>
                          <Tooltip content="You can add new License/Certification here and edit it later.  " style="light" placement="right" className="flex"><QuestionMarkCircleIcon className="h-5 w-5 cursor-pointer flex"/></Tooltip>
            ...
            {resumeDetails && resumeDetails.certifications && resumeDetails.certifications.length > 0 && (
                                ...
                                <h3 className="text-lg font-medium leading-6 text-gray-900 dark:text-gray-200">
                                    { certification.certificationUrl ? (
                                        ...
                                        <span>
                                            {certification.certificationName}
                                            { certification.certificationIssueDate && " ( "+certification.certificationIssueDate } {certification.certificationExpirationDate && " - " + certification.certificationExpirationDate}
                                            countryCode          { certification.certificationIssueDate && " )"}
                                        </span>
                                    ) }
