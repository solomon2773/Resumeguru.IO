        ...
        <main className="mx-auto mt-2 max-w-7xl px-4 px-6 sm:mt-24 lg:mt-32 sm:mb-24 lg:mb-32">
            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                ...
                {/*</span>*/}
                  ...
                  <span className="block text-gray-900">Accelerate Your Job Hunt</span>
                  <span className="block text-blue-600">with AI-Powered Tools</span>
                </span>
                    </h1>
                    <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                        Create stunning resumes, ace your interviews, and land your dream job faster with ResumeGuru.io.                    </p>
